...
use clauditty_config_derive::{ConfigDeserialize, SerdeReplace};

use clauditty_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the Clauditty window.
    Hide,

    /// Hide all windows other than Clauditty on macOS.
    HideOtherApplications,

    /// Minimize the Clauditty window.
    Minimize,
    ...
    /// Spawn a new instance of Clauditty.
    SpawnNewInstance,
