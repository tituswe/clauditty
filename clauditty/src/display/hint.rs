...
use clauditty_terminal::grid::{BidirectionalIterator, Dimensions};
use clauditty_terminal::index::{Boundary, Column, Direction, Line, Point};
use clauditty_terminal::term::cell::Hyperlink;
use clauditty_terminal::term::search::{Match, RegexIter, RegexSearch};
use clauditty_terminal::term::{Term, TermMode};
...
mod tests {
    ...
    use clauditty_terminal::term::test::mock_term;
    use clauditty_terminal::vte::ansi::Handler;
