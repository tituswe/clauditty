...
use clauditty_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `clauditty_terminal` damage information into renderer damaged rects.
